...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.rooms.store'], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('tenants[]', $tenants, old('tenants'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'id' => 'selectall-tenants' ]) !!}
                    <p class="help-block"></p>
